...
var ExplorerCallbacksCtx = createContext({ expandingNode: null });
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 4, marginTop: 4 }, children: [
          ...
          /* @__PURE__ */ jsxs("span", { style: { fontSize: 9, color: "var(--tx-caption, #64748b)" }, children: [
            "d",
            node.depth
          ] })
        ] }),
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              data?.token && /* @__PURE__ */ jsx(TokenIcon, { token: data.token }),
              label
            ]
          }
        )
  ...
  return /* @__PURE__ */ jsxs2("div", { style: { position: "relative", width: "100%", height: "100%" }, children: [
    ...
    /* @__PURE__ */ jsxs2(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx2("button", { title: "Zoom In", onClick: zoomIn, style: controlBtnStyle, children: "+" }),
          /* @__PURE__ */ jsx2("button", { title: "Zoom Out", onClick: zoomOut, style: controlBtnStyle, children: "\u2212" }),
          /* @__PURE__ */ jsx2("button", { title: "Fit View", onClick: handleFitView, style: controlBtnStyle, children: "\u22A1" })
        ]
      }
    ),

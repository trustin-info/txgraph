...
var ExplorerCallbacksCtx = createContext({ expandingNode: null, isDark: true });
function ExplorerNode({ data, id }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Handle, { type: "target", id: "target-left", position: Position.Left, style: { background: "#6b7280", width: 8, height: 8, top: "40%" } }),
        /* @__PURE__ */ jsx(Handle, { type: "source", id: "source-left", position: Position.Left, style: { background: "#06b6d4", width: 8, height: 8, top: "60%" } }),
        isLoading && /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx(Loader2, { size: 20, style: { color: "#60a5fa", animation: "spin 1s linear infinite" } })
          }
        ),
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 4, marginBottom: 4, flexWrap: "wrap" }, children: [
          node.is_root && /* @__PURE__ */ jsx(
            "span",
            {
              style: {
                fontSize: 9,
          ...
          node.is_stopped && /* @__PURE__ */ jsx(AlertTriangle, { size: 11, style: { color: "#f59e0b", flexShrink: 0 } }),
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 4, marginTop: 4 }, children: [
          ...
          /* @__PURE__ */ jsxs("span", { style: { fontSize: 9, color: isDark ? "#64748b" : "#94a3b8" }, children: [
            "d",
            node.depth
          ] })
        ] }),
        !node.is_root && !node.is_stopped && onNodeExpand && /* @__PURE__ */ jsx(
          "button",
          {
            style: {
              position: "absolute",
        ...
        !node.is_root && onNodeDelete && /* @__PURE__ */ jsx(
          "button",
          {
            style: {
              position: "absolute",
        ...
        /* @__PURE__ */ jsx(Handle, { type: "source", id: "source-right", position: Position.Right, style: { background: "#8b5cf6", width: 8, height: 8, top: "40%" } }),
        /* @__PURE__ */ jsx(Handle, { type: "target", id: "target-right", position: Position.Right, style: { background: "#6b7280", width: 8, height: 8, top: "60%" } })
      ]
    }
  );
}
...
function AmountEdge({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(BaseEdge, { id, path, style, markerEnd }),
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              typeof edgeData?.token === "string" && /* @__PURE__ */ jsx(TokenIcon, { token: edgeData.token }),
              label
            ]
          }
        )
...
function TokenIcon({ token }) {
  ...
  if (t === "usdt") {
    return /* @__PURE__ */ jsxs("svg", { width: "12", height: "12", viewBox: "0 0 32 32", style: { display: "inline-block", verticalAlign: "middle", marginRight: 2 }, children: [
  ...
  if (t === "usdc") {
    return /* @__PURE__ */ jsxs("svg", { width: "12", height: "12", viewBox: "0 0 32 32", style: { display: "inline-block", verticalAlign: "middle", marginRight: 2 }, children: [
      /* @__PURE__ */ jsx("circle", { cx: "16", cy: "16", r: "16", fill: "#2775CA" }),
...
function GraphExplorer({
  ...
  return /* @__PURE__ */ jsxs("div", { style: { width: "100%", height: "100%", position: "relative" }, children: [
    /* @__PURE__ */ jsx(ExplorerCallbacksCtx.Provider, { value: ctxValue, children: /* @__PURE__ */ jsxs(
      ReactFlow,
      {
        nodes,
        edges,
        ...
        children: [
          /* @__PURE__ */ jsx(Background, { color: isDark ? "#374151" : "#d1d5db", gap: 20 }),
    ...
    loading && /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx(Loader2, { size: 36, style: { color: "#60a5fa", animation: "spin 1s linear infinite" } }),
          /* @__PURE__ */ jsx("span", { style: { color: "#94a3b8", fontSize: 13 }, children: "Exploring graph\u2026" })
        ]
      }
    )
  ] });
...
import { useEffect as useEffect2, useRef as useRef2, useMemo as useMemo2, useCallback, useState as useState2 } from "react";
...
function GraphExplorerSigma({
  ...
  const sigmaRef = useRef2(null);
  const graphRef = useRef2(null);
  ...
  const colorsRef = useRef2(colors);
  useEffect2(() => {
    colorsRef.current = colors;
  }, [colors]);
  const isDarkRef = useRef2(isDark);
  useEffect2(() => {
  ...
  return /* @__PURE__ */ jsxs2("div", { style: { position: "relative", width: "100%", height: "100%" }, children: [
    loading && /* @__PURE__ */ jsxs2(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx2(Loader22, { size: 36, style: { color: "#60a5fa", animation: "spin 1s linear infinite" } }),
          /* @__PURE__ */ jsx2("span", { style: { color: "#94a3b8", fontSize: 13 }, children: "Exploring graph\u2026" })
        ]
      }
    ),
    /* @__PURE__ */ jsx2("div", { ref: containerRef, style: { width: "100%", height: "100%", background: colors.bg } }),
    /* @__PURE__ */ jsxs2(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ jsx2("button", { title: "Zoom In", onClick: zoomIn, style: controlBtnStyle(isDark), children: "+" }),
          /* @__PURE__ */ jsx2("button", { title: "Zoom Out", onClick: zoomOut, style: controlBtnStyle(isDark), children: "\u2212" }),
          /* @__PURE__ */ jsx2("button", { title: "Fit View", onClick: handleFitView, style: controlBtnStyle(isDark), children: "\u22A1" })
        ]
      }
    ),
    (stats || nodes.length > 0) && /* @__PURE__ */ jsx2(
      "div",
      {
        style: {
          position: "absolute",
